...
labels = load_labels("C:/Users/DELL/Downloads/Video Api/labels.txt")  # Ensure this path matches your directory structure
...
async def upload_video(video: UploadFile = File(...)):
    try:
        ...
        # Load TFLite model
        interpreter = tf.lite.Interpreter(model_path="C:/Users/DELL/Downloads/Video Api/model_unquant.tflite")
